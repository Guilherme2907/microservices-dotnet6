...
namespace GeekShopping.CartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartVO> SaveOrUpdateCart(CartVO cartVO)
        {
            ...
            // Checks id the product is already saved in the database if it does not exists then save
            ...
            else
            {
                ...
                var cartDetail = await _context.CartDetails.AsNoTracking().FirstOrDefaultAsync(c =>
